package eu.schk.jhipster.demo.web.rest;

import static org.assertj.core.api.Assertions.assertThat;

import eu.schk.jhipster.demo.IntegrationTest;
import eu.schk.jhipster.demo.config.EmbeddedKafka;
import eu.schk.jhipster.demo.config.KafkaSseConsumer;
import eu.schk.jhipster.demo.config.KafkaSseProducer;
...
class JhipsterdemoKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/jhipsterdemo-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/jhipsterdemo-kafka/consume")
