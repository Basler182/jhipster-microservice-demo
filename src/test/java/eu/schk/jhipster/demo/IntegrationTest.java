package eu.schk.jhipster.demo;

import eu.schk.jhipster.demo.JhipsterdemoApp;
import eu.schk.jhipster.demo.config.AsyncSyncConfiguration;
import eu.schk.jhipster.demo.config.EmbeddedKafka;
import eu.schk.jhipster.demo.config.EmbeddedSQL;
