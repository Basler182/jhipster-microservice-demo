package eu.schk.jhipster.demo.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("eu.schk.jhipster.demo.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("eu.schk.jhipster.demo.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
